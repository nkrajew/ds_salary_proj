...
df_model = df[['avg_salary', 'Rating', 'Type of ownership', 'Industry', 'Sector', 'Revenue', 'hourly', 'job_state', 'age', 'python_yn', 'spark_yn', 'aws_yn', 'excel_yn', 'SQL_yn', 'tableau_yn', 'job_simp', 'seniority', 'desc_len']]
